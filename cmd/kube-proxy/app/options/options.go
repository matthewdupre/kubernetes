...
type ProxyServerConfig struct {
	...
	ProxyMode                      string
	IptablesMarkMask               uint32
	IptablesMarkValue              uint32
...
func (s *ProxyServerConfig) AddFlags(fs *pflag.FlagSet) {
	...
	fs.UInt32Var(&s.IptablesMarkMask, "iptables-mark-mask", s.IptablesMarkMask, "If using the pure iptables proxy, the mask to use for the SNAT iptables mark.")
	fs.UInt32Var(&s.IptablesMarkValue, "iptables-mark-value", s.IptablesMarkValue, "If using the pure iptables proxy, the value to use for the SNAT iptables mark.  Must be non-zero after masking with iptables-mark-mask.")
